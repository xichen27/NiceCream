...
IceCream.create!(flavor: "vanilla", creamery_id: 5, image_url: "https://s3-us-west-1.amazonaws.com/nicecreamsimages/vanilla-cold-stone.jpeg")
IceCream.create!(flavor: "strawberry", creamery_id: 8 , image_url: "https://s3-us-west-1.amazonaws.com/nicecreamsimages/strawberry-san-fran-creamery.jpeg")
IceCream.create!(flavor: "coffee", creamery_id: 7 , image_url: "https://s3-us-west-1.amazonaws.com/nicecreamsimages/coffee-carvel.jpeg")
...
IceCream.find(4).reviews.create(user_id: 5, rating: 3)
IceCream.find(7).reviews.create(user_id: 5, rating: 4)
IceCream.find(8).reviews.create(user_id: 5, rating: 5)
...
Refrigerating.create!(ice_cream_id: 9, user_id: 5)
Refrigerating.create!(ice_cream_id: 12, user_id: 5)
